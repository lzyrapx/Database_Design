...
//添加代码
#include <odbcinst.h>     //SQLConfigDataSource函数的ODBC API所在的头文件
#include "LoginDlg.h"
//添加代码结束
#ifdef _DEBUG
...
CDatabaseApp::CDatabaseApp()
{
	...
	//添加代码
	m_bHasSuperAuthority = FALSE; //初始化m_bHasSuperAuthority
	//添加代码结束
}
...
BOOL CDatabaseApp::InitInstance()
{
	...
	//添加代码
	/*****************************************************************/
	//     SQLConfigDataSource()函数实现ODBC数据源的自动安装         //
	/*****************************************************************/
	...
	//设置系统主界面标题
	AfxGetMainWnd() ->SetWindowText("高校人事信息数据库应用系统");
	//添加代码结束
	return TRUE;
}
